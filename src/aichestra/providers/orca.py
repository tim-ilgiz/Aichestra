    ...
    def send(
        ...
        if role == "mode_c_handoff":
            ...
            contract = (
                ...
                "ExecutionTargets:\n"
                "The coordinator package includes canonical execution_targets and "
                "execution_policy (execution_target_contract_version). "
                "Allowed ExecutionTargets carry capabilities, locality, availability, "
                "launchability (launch_strategy/runnable), and preferences. "
